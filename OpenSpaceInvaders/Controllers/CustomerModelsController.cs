...
namespace OpenSpaceInvaders.Controllers
{
    public class CustomerModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Email,PhoneNumber")] CustomerModel customerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Email,PhoneNumber")] CustomerModel customerModel)
        {
